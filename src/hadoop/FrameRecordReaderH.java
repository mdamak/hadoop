...
public class FrameRecordReaderH implements RecordReader<NullWritable, BytesWritable> {
  ...
  public FrameRecordReaderH(Configuration job, 
                          FileSplit split) throws IOException {
    this(job, split, null);
  }

  public FrameRecordReaderH(Configuration job, FileSplit split,
  ...
  public FrameRecordReaderH(InputStream in, long offset, long endOffset,
                          int maxLineLength) {
